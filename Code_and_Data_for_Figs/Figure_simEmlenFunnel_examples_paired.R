...
list_fig1 <- list(FigureC_10, FigureC_100,FigureC_1000,
                  FigureD_10, FigureD_100,FigureD_1000)
...
specs_Fig1 <- c("Figure_EmlenFunnel_paired.pdf","Type 1 error","Power","Sample size (number IDs = n)",0.10,1)
...
for (i in 1:nrow(specs)) {
  ...
  col_legen_1=colors_plot[c("Rayleigh_col","MANOVA_linear_group_groupP_col","MANOVA_random_linear_group_groupP_col",
                            "LM_lin_group_P_group_col")]
  
  legend_1= function(){legend("topleft", legend=c("Moores paired (IDs averaged)","MANOVA re group (group)","simMANOVA re group (group)",
                                                     "LMM group (group)"),
                              col=col_legen_1,cex = 1.1, lty=c(1:6,1:5),pch = 1,bty="n", #lty needs to be corrected
  ...
  lines(FigurexA$nseq,FigurexA$LM_group_groupP,col=col_legen_1[4],lty=4,type = "b",pch = 1,lwd = 0.6)
  ...
  lines(FigurexB$nseq,FigurexB$LM_group_groupP,col=col_legen_1[4],lty=4,type = "b",pch = 1,lwd = 0.6)
  ...
  #need to change the y-axis for the type 1 erro 
  plot(FigurexC$nseq,FigurexC$Moores_paired ,col=col_legen_1[1],type = 'b',lty=1,pch = 1,bty="n" ,
       ylab = ylab,xlab=xlab,xlim = c(xmin,xmax),ylim = c(0,ymax),lwd = 0.6)
  lines(FigurexC$nseq,FigurexC$MANOVA_groupP,col=col_legen_1[2],lty=2,type = "b",pch = 1,lwd = 0.6,)
  lines(FigurexC$nseq,FigurexC$MANOVA_random_groupP ,col=col_legen_1[3],lty=3,type = "b",pch = 1,lwd = 0.6)
  lines(FigurexC$nseq,FigurexC$LM_group_groupP,col=col_legen_1[4],lty=4,type = "b",pch = 1,lwd = 0.6)
  ...
  #need to change the y-axis for the type 1 erro 
  plot(FigurexD$nseq,FigurexD$Moores_paired ,col=col_legen_1[1],type = 'b',lty=1,pch = 1,bty="n" ,
       ylab = ylab,xlab=xlab,xlim = c(xmin,xmax),ylim = c(0,ymax),lwd = 0.6)
  lines(FigurexD$nseq,FigurexD$MANOVA_groupP,col=col_legen_1[2],lty=2,type = "b",pch = 1,lwd = 0.6,)
  lines(FigurexD$nseq,FigurexD$MANOVA_random_groupP ,col=col_legen_1[3],lty=3,type = "b",pch = 1,lwd = 0.6)
  lines(FigurexD$nseq,FigurexD$LM_group_groupP,col=col_legen_1[4],lty=4,type = "b",pch = 1,lwd = 0.6)
  ...
  #need to change the y-axis for the type 1 erro 
  plot(FigurexE$nseq,FigurexE$Moores_paired ,col=col_legen_1[1],type = 'b',lty=1,pch = 1,bty="n" ,
       ylab = ylab,xlab=xlab,xlim = c(xmin,xmax),ylim = c(0,ymax),lwd = 0.6)
  lines(FigurexE$nseq,FigurexE$MANOVA_groupP,col=col_legen_1[2],lty=2,type = "b",pch = 1,lwd = 0.6,)
  lines(FigurexE$nseq,FigurexE$MANOVA_random_groupP ,col=col_legen_1[3],lty=3,type = "b",pch = 1,lwd = 0.6)
  lines(FigurexE$nseq,FigurexE$LM_group_groupP,col=col_legen_1[4],lty=4,type = "b",pch = 1,lwd = 0.6)
 ...
 # abline(h=0.05,lty=2,col="grey")
  ...
  #need to change the y-axis for the type 1 erro 
  plot(FigurexF$nseq,FigurexF$Moores_paired ,col=col_legen_1[1],type = 'b',lty=1,pch = 1,bty="n" ,
       ylab = ylab,xlab=xlab,xlim = c(xmin,xmax),ylim = c(0,ymax),lwd = 0.6)
  lines(FigurexF$nseq,FigurexF$MANOVA_groupP,col=col_legen_1[2],lty=2,type = "b",pch = 1,lwd = 0.6,)
  lines(FigurexF$nseq,FigurexF$MANOVA_random_groupP ,col=col_legen_1[3],lty=3,type = "b",pch = 1,lwd = 0.6)
  lines(FigurexF$nseq,FigurexF$LM_group_groupP,col=col_legen_1[4],lty=4,type = "b",pch = 1,lwd = 0.6)
